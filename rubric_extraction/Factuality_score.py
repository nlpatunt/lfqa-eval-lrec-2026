...
class Factuality_score(object):
    ...
    def compute(self,router,question,answer):
        ...
        prompt_file_path = r'C:\Users\rafid\Source\Repos\lfqa-eval\prompt\geval_factuality_instructions.txt'
    ...
    def compute_veriscore(self,router,question,answer):

        prompt_file_path = r'C:\Users\rafid\Source\Repos\lfqa-eval\prompt\veriscore_replication_instructions.txt'
